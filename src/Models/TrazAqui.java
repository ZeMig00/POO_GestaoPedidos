...
public class TrazAqui implements Serializable {
    ...
    //Quando existe uma tentativa de login é aqui que está a informção para validar o login.
    ...
    /**
     * Função que é chamada quando uma se pretende pedir ao sistema para entregar uma encomenda.
     * Função responsavél por verificar se alguem disponivel têm as caracteristicas necessarias para entregar a encomenda.
     * Funçao que responsavel por guardar as encomenadas sinalizadas como porntas por uma loja.
    ...
    /**
     * Função responsavél por colocar na respetiva loja o numero (indicado) de pessoas na fila espera.
    ...
    /**
     * Função por retornar o historico de uma loja em formato List.
    ...
    /**
     * Função que remove um produto da loja
    ...
    /**
     * Função responsavel por adicionar um produto a uma loja
    ...
    /**
     * Função responsavel por devolver o pedido que esta a ser aceite pela loja.
     * @param posEnc posiçao indicada do pedido a ir buscar.
    ...
    /**
     * Função que retorna em List<String> os pedidos que uma loja tem por aceitar.
    ...
    /**
     * Função responsavel por retirar um pedido da fila de espera de uma loja
    ...
    /**
     * Função responsavel por dar a um utilizador a lista de lojas disponiveis no sistema, para
    ...
    /**
     * Função responsavel por retornar os produtos existentes numa loja.
    ...
    /**
     * Funçao que recebe uma encomenda e transforma-a num pedido a uma loja, pondo-o na fila de espera dessa loja.
    ...
    /**
     * Função responsavel por devolver um produto de uma determinada loja.
    ...
    /**
     * Função responsavel por devolver o historico de um utilizador (em forma de lista).
    ...
    /**
     * Função que retorna os transportadores disponiveis no momento para avliar por um dado transportador.
    ...
    /**
     * Funçao responsavel por devolver uma lista com as notificações de um utilizador.
    ...
    /**
     * Funcao responsavel por limpar todas as notificaçoes de um utilizador.
    ...
    /**
     * Função reponsavel por aceitar uma transportadora que pediu para entregar uma encomenda deste utilizador.
    ...
    /**
     * Função responsavel por rejeitar uma transportadora que pediu para entregar uma encomenda deste utilizador.
    ...
    /**
     * Funcao que vai mudar o preco por kilometro de uma transportadora
    ...
    /**
     * Funcao responsavel por atualizar a velocidade media de um transportador
    ...
    /**
     * Funcao que atualiza o novo raio de acao de um transportador
     * @param cod codigo do transportador a aplicar a mudança
    ...
    /**
     * Função que retorna uma lista dos pedidos que uma transportadora fez a um utilizador
    ...
    /**
     * Funçao retorna a lista de encomendas que existem para ser entregues.
     * @return lista de encomedas (formato string) no sistema para ser entregues.
     */
    public List<String> encomendaParaEntrega(){
        return this.pedidosParaRecolha.values().parallelStream().map(p->p.toString()).collect(Collectors.toList());
    }

    /**
     * Funçao responsavel por aceitar um pedido de entrega de um transportador (tanto Volunario como transportadora)
    ...
    /**
     * Funçao responsavel por avaliar um transportador.
     ...
     * @throws ValorErradoException caso a avaliaçao nao seja valida ou seja nao respeite o farmato de 0-5
     */
    ...
    /**
     * Funçao que retorna o historico dos transportadores
    ...
    /**
     * Funçao responsavel por finalizar a entrega atual de um transportador
    ...
    /**
     * Funçao que muda o estado de um transportador de indisponivel para disponivel e virse-versa
    ...
    /**
     * Funçao responsavel por mostar as estatisticas ao dono do sistema, mais propriamente sobre o quanto ganhou
     * uma loja.
    ...
    /**
     * Funçao reponsavel por devolver uma lista com o top 10 utilizadores
    ...
    /**
     * Funçao responsavel por devolver a lista do top 10 transportadora em funçao do numero de km
    ...
    /**
     * Funçao responsavel por devolver o perfil da pessoa com o email dado
    ...
    /**
     * Funçao responsavel por adicionar um perfil ao sistema
    ...
    /**
     * Funçao responsavel por adicionar uma transportadora no sistema
    ...
    /**
     * Função responsavel por adicionar um utilizador no sistema
    ...
    /**
     * Funçao responsavel por adicionar uma loja ao sistema
    ...
    /**
     * Funçao responsavel por guardar o estado do sistema em formato binario
    ...
    /**
     * Funçao responsavel por gerar um novo codigo de utilizador
    ...
    /**
     * Funçao responsavel por gerar um novo codigo de voluntario
     * @return novo codigo gerado
     */
    ...
    /**
     * Funçao responsavel por gerar um novo codigo de transportadora
     * @return novo codigo gerado
     */
    ...
    /**
     * Funçao responsavel por gerar um novo codigo de loja
     * @return novo codigo gerado
     */
    ...
    /**
     * Funçao responsavel por gerar um novo codigo de encomenda
     * @return novo codigo gerado
     */
    ...
    /**
     * Funçao responsavel por gerar um novo codigo de produto
     * @return novo codigo gerado
     */
